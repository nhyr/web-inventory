  ...
  <div style="text-align: center;padding-top: 5px;">
    ...
    <div style="border: 0; width: 70%;padding: 0;">
      <table id="jj" style="margin:0">
        ...
        <tr>
          <td class="jdl">Operator</td><td>:&nbsp;&nbsp;</td><td class="jdl"><?=$row['nama']?></td>
        </tr><br>
        <tr>
...
<table style="width: 1000px;font-size: 20px;text-align: center;">
            ...
            <tfoot>
                                                        <tr>
                                                          <td colspan="4"><b>Jumlah</b></td><td style="text-align: center;"><b><?=$tzak?></b></td><td style="text-align: right;"><b><?=$jml?>&nbsp;<?=$key['satuan']?></b></td>
                                                        </tr>
                                                    </tfoot>
          </table>
