        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="v-no_transfer_file">No Transfer File</label>
              <input type="text" class="form-control" id="v-no_transfer_file" name="v-no_transfer_file" placeholder="No Surat Jalan" maxlength="20" readonly>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="v-nama_customer">Nama Operator</label>
...
$(document).ready(function() {
  ...
  var l_no_surat_jalan = $(event.relatedTarget).data('l-no_transfer_file')
  ...
  $(this).find('#v-no_transfer_file').val(no_transfer_file)
